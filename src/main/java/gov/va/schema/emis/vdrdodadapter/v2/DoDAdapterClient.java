...
public class DoDAdapterClient {
    ...
    public JAXBElement<EMISmilitaryServiceEligibilityResponseType> getMilitaryServiceEligibilityResponse (String value) {
        ...
        JAXBElement<EMISmilitaryServiceEligibilityResponseType> response = (JAXBElement<EMISmilitaryServiceEligibilityResponseType>) DoDAdapterWebServiceTemplate.marshalSendAndReceive(request);
